...
import IteratePendingItemScreen from "@/extra/pages/sbrequest/pendingRequest/eventattendent/renderItem";
import { useRouter } from "next/navigation";
const SBPendingAttendentScreen = ({ params }: any) => {
  ...
  const retrivedAttendentData = () => {
    api.sb_attendent
      .retriveStatusBasedSBAttendentData(parseInt(eventId ? eventId : "0"), 0)
      .pipe(
...
export default SBPendingAttendentScreen;
