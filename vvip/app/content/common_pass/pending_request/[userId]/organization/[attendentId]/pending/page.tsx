...
import IteratePendingItemScreen from "@/extra/pages/requests/pendingRequest/renderItem";

const PendingAttendentScreen = ({ params }: any) => {
  ...
  const retrivedAttendentData = () => {
    api.attendent
      .retriveStatusBasedAttendentData(
        parseInt(attendentId ? attendentId : "0"),
        0
      )
      .pipe(
...
export default PendingAttendentScreen;
