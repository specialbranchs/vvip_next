...
const AddAttendentScreen = () => {
  const dispatch = useDispatch();
  const attendentlist = useSelector(
  ...
  const formik = useFormik({
    ...
    validationSchema,
    onSubmit: (values) => {
      let newValues:UploadAttendentType={
        ...values,
        uniqueId:Date.now()
      }
      const newlist = [...attendentlist, newValues];
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={4}>
            <SelectionCommonComponent
              ...
              error={formik.touched.requisition && Boolean(formik.errors.requisition)}
...
export default AddAttendentScreen;
